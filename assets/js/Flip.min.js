...
!function(t, e) {
  ...
  function x(t, e) {
    if (t.parentNode && (g || p(t))) {
      ...
      return e && (i ? (d = d || x(t),
        ...
        d.appendChild(l)) : (f || ((f = x(t)).style.cssText = o),
  ...
  function A(t, e) {
    var i, n, r, a, s, o, l = v(t), u = t === l, h = l ? E : M, p = t.parentNode, c = p && !l && p.shadowRoot && p.shadowRoot.appendChild ? p.shadowRoot : p;
    if (t === y)
      return t;
    if (h.length || h.push(x(t, 1), x(t, 2), x(t, 3)),
      i = l ? d : f,
      l)
      u ? (a = -(r = z(t)).e / r.a,
        s = -r.f / r.d,
        n = m) : t.getBBox ? (r = t.getBBox(),
        a = (n = (n = t.transform ? t.transform.baseVal : {}).numberOfItems ? 1 < n.numberOfItems ? function _consolidate(t) {
          ...
          return e
        }(n) : n.getItem(0).matrix : m).a * r.x + n.c * r.y,
        s = n.b * r.x + n.d * r.y) : (n = new F,
        a = s = 0),
      ...
      if (a = s = 0,
        ...
        for (n = t.offsetParent,
          ...
          4 < (y.getComputedStyle(r)[k] + "").length && (a = r.offsetLeft,
            s = r.offsetTop,
            r = 0);
  ...
  var g, y, a, b, f, d, m, s, w, i, k = "transform", C = k + "Origin", E = [], M = [], F = ((i = Matrix2D.prototype).inverse = function inverse() {
    var t = this.a
      , e = this.b
      , i = this.c
      , n = this.d
  ...
  function ja(e, i, n) {
    var r, a, s, o = e.element, l = e.width, h = e.height, p = e.uncache, c = e.getProp, f = o.style, d = 4;
      ...
      m = function run() {
        for (ea(H),
          ...
          h = H[l],
            g = h.a,
            v = h.b,
            !D || g.isDifferent(v) || h.entering ? (u = h.t,
            !L || h.sd < 0 || !l || (g.matrix = getGlobalMatrix(u, !1, !1, !0)),
              v.isVisible && g.isVisible ? (h.sd < 0 ? (p = new ht(u,z,t.simple),
                ot(p, g, A, 0, 0, p),
                p.matrix = getGlobalMatrix(u, !1, !1, !0),
                p.css = h.b.css,
                h.a = g = p,
              T && (u.style.opacity = J ? v.opacity : g.opacity),
              O && q.push(u)) : 0 < h.sd && T && (u.style.opacity = J ? g.opacity - v.opacity : "0"),
  ...
  var I, Q, tt, r, o, P, T, l, n, c = 1, h = {}, O = 180 / Math.PI, N = Math.PI / 180, D = {}, Y = {}, et = {}, it = S("onStart,onUpdate,onComplete,onReverseComplete,onInterrupt"), nt = S("transform,transformOrigin,width,height,position,top,left,opacity,zIndex,maxWidth,maxHeight,minWidth,minHeight"), rt = {
    zIndex: 1,
    kill: 1,
    simple: 1,
    spin: 1,
    ...
    var s, o, l, u, h, p, c, f = t.element, d = t.cache, m = t.parent, g = t.x, v = t.y, y = e.width, x = e.height, b = e.scaleX, w = e.scaleY, S = e.rotation, k = e.bounds, _ = a && T && T(f, "transform,width,height"), C = t, V = e.matrix, E = V.e, M = V.f, B = t.bounds.width !== k.width || t.bounds.height !== k.height || t.scaleX !== b || t.scaleY !== w || t.rotation !== S, F = !B && t.simple && e.simple && !r;
    return F || !m ? (b = w = 1,
      S = s = 0) : (p = (h = function _getInverseGlobalMatrix(t) {
    ...
    n.compare = function compare(t) {
      ...
      var e, i, n, r, a, s, o, l, u = t.idLookup, h = this.idLookup, p = [], c = [], f = [], d = [], m = [], g = t.alt, v = this.alt;
      for (n in u)
        a = g[n],
          s = v[n],
          ...
          s ? (l = i.isVisible || !s.isVisible && r === i.element ? i : s,
            (o = !a || e.isVisible || a.isVisible || l.element !== a.element ? e : a).isVisible && l.isVisible && o.element !== l.element ? ((o.isDifferent(l) ? c : p).push(o.element, l.element),
              m.push(o.element, l.element)) : lh(o, l, o.element),
          a && o.element === a.element && (a = u[n]),
            mh(o.element !== i.element && a ? a : o, i, i.element),
            mh(a && a.element === s.element ? a : o, s, s.element),
          a && mh(a, s.element === a.element ? s : i, a.element)) : (i ? i.isDifferent(e) ? lh(e, i, r) : p.push(r) : f.push(r),
          a && mh(a, i, a.element));
      for (n in h)
        u[n] || (d.push(h[n].element),
    ...
    q.update = function update(e, i) {
      ...
      s.uncache = 1,
        ...
        n.id = function _getID(t) {
          ...
          return e || t.setAttribute("data-flip-id", e = "auto-" + c++),
            e
        }(r),
        n.matrix = h,
        n.cache = s,
